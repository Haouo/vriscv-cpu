...
import lab10.PiplinedCPU.Controller._        // use lab10_2 controller
...
class PiplinedCPU(memAddrWidth: Int, memDataWidth: Int) extends Module {
    ...
    datapath_EXE.io.v_E_ASel := contorller.io.vector_E_ASel  // lab 10-4
    datapath_EXE.io.v_E_BSel := contorller.io.vector_E_BSel  // lab 10-4
    datapath_EXE.io.v_E_ALUSel := contorller.io.vector_E_ALUSel  // lab 10-4
