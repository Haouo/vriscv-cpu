...
class Top extends Module {
  ...
  io.dataMemIsIdle  := dataMem.io.isIdle
  io.isRead         := dataMem.io.isRead
  io.isWrite        := dataMem.io.isWrite
  io.readAddrValid  := dataMem.io.readAddrValid
  io.readLength     := dataMem.io.readLength
  io.writeAddrValid := dataMem.io.writeAddrValid
  io.writeLength    := dataMem.io.writeLength
  io.MEM_raddr      := dataMem.io.rAddr
  io.MEM_rdata      := dataMem.io.rData
